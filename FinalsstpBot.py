# change "my_token" and "Your_channel_Id with your own
import logging
...
def get_persian_date_time():
    ...
    #change this base on your server location
    # base on idiotic actions from not goverment but a cult\
    # i can't set the time of Tehran correctlly so i used this for that.
    hour = now.hour + 3
...
def send_server_list(bot):
    ...
    # Send SSTP document
    channel = bot.get_chat("Your_channel_Id")
    ...
    names = ['Worker .ir' , 'Worker .link', 'mahdibland Eternity',
        ...
        'Bardiafa vless',
         ...
         'Telegram collector: Base64_vless',
         'Telegram collector: Base64_reality',
         ]
    count = 0
...
def start(update: Update, context: CallbackContext):
    ...
    context.bot.send_document(chat_id=update.effective_chat.id, document=open('/home/hemay/sstp.html', 'rb'), caption="SSTP Servers")
    links = [
        'https://link.mehdi-hoore.workers.dev/sub/f.sabaat.link',
        'https://fin.hore.workers.dev/sub/fin.sabaat.ir',
        'https://raw.githubusercontent.com/mahdibland/ShadowsocksAggregator/master/Eternity',
...
if __name__ == '__main__':
    updater = Updater(token='my_token', request_kwargs={'read_timeout': 30})
    ...
    job_queue.run_repeating(send_job, interval= 2 * 60 * 60, first=0)
